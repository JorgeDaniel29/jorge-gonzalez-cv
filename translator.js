const translations = {
  es: {
    ...
    summary_p1: "Soy un desarrollador de software especializado en Android con más de 9 años de experiencia, actualmente trabajando como Líder Técnico de Software en Mercado Libre. Poseo una comprensión integral de los ciclos de vida del desarrollo Android, frameworks, componentes de arquitectura, analíticas móviles y metodologías ágiles.",
  ...
  en: {
    ...
    summary_p1: "I am a software developer specializing in Android with over 9 years of experience, currently working as a Software Technical Lead at Mercado Libre. I possess a comprehensive understanding of Android development lifecycles, frameworks, architecture components, mobile analytics, and agile methodologies.",
    summary_p2: "I have a strong focus on software architecture, especially Clean Architecture and MVVM, combining technical excellence with leadership skills to guide teams and define quality standards. I am dedicated to implementing new technologies to produce scalable, maintainable, innovative, and robust applications within the Mercado Pago ecosystem.",
    summary_p3: "As an enthusiast of computer science, algorithms, and programming, I continuously expand my knowledge through research, technical literature, and staying current with industry trends. I am passionate about building efficient solutions with real impact on user experience, constantly seeking challenges that drive professional growth and add value to high-impact projects.",
